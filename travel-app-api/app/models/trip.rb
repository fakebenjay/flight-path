class Trip < ApplicationRecord
  ...
  def retreive_lng_lat_img_url
    ...
    img_search_url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=#{self.lat},#{self.lng}&radius=50000&rankBy=prominence&key=AIzaSyBw8FxFBj6YcZHcc-6RKvAh1mpnVP7VRvM"
