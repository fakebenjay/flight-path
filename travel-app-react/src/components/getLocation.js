...
class GetLocation extends Component {
  ...
  render() {
    return (
      <div>
        <input type="text" className="col-md-2 col-md-offset-5 text-center custom-input trip-planning-field" placeholder="Find A City" onChange={this.handleChange} value={this.props.location.formattedName.length > 0 ? this.props.location.formattedName : this.state.query} />
